...
/**
 * Panel Cek Stok Barang - Embeddable untuk Sidebar Menu
 * @author LENOVO
 */
public class ViewCekStok extends JPanel {
    ...
    public ViewCekStok() {
        ...
        // Tabel Barang 
        String[] colBarang = {"ID Barang", "Nama Barang", "Nama Kategori", "Harga Beli", "Harga Jual", "Stok"};
